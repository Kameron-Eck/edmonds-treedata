...
- Wehmann, A. & Liu, D. (2015). A spatial–temporal contextual Markovian kernel method for multi-temporal land cover mapping. *ISPRS J.* 107. doi:10.1016/j.isprsjprs.2015.04.009 — **METADATA** **Obtained 2026-09-13 (Anna's Archive member route), header-verified, unread by the reviewer. Filed `Wehmann_2015_spatial-temporal-contextual-markovian-kernel`.**
...
- Hoberg, T., Rottensteiner, F., Feitosa, R.Q. & Heipke, C. (2015). Conditional Random Fields for Multitemporal and Multiscale Classification of Optical Satellite Imagery. *IEEE TGRS* 53(2). doi:10.1109/TGRS.2014.2326886 — **METADATA** (confirmed unreadable 2026-09-11: no OA/repository copy, five Sci-Hub mirrors empty) **Obtained 2026-09-13 (Anna's Archive member route), header-verified, unread by the reviewer. Filed `Hoberg_2015_conditional-random-fields-multitemporal-multiscale`.**
...
- Cardille, J.A. & Fortin, J.A. (2016). Bayesian updating of land-cover estimates in a data-rich environment. *RSE* 186. doi:10.1016/j.rse.2016.08.021 — **METADATA ⚠ NUMBERS** **Obtained 2026-09-13 (Anna's Archive member route), header-verified, unread by the reviewer. Filed `Cardille_2016_bayesian-updating-land-cover`.**
...
- Song, J., Chen, H. & Yokoya, N. (2026). Enhancing monocular height estimation via sparse LiDAR-guided correction. *ISPRS J.* 232. doi:10.1016/j.isprsjprs.2025.12.004 — **ABSTRACT** **Obtained 2026-09-13 (open access, arXiv 2505.06905, curl), header-verified, unread by the reviewer. Filed `Song_2026_monocular-height-sparse-lidar-correction`. Note: the first Anna's Archive fetch attempt was mis-matched to an unrelated 2011 time-of-flight-camera paper (same defect as Chen 2024 below) and was quarantined.**
...
- Brown, J. et al. (2022). Automated aerial animal detection when spatial resolution conditions are varied. *Computers and Electronics in Agriculture*. doi:10.1016/j.compag.2022.106689 — **ABSTRACT** **Obtained 2026-09-13 (open access, arXiv 2110.01329, curl), header-verified, unread by the reviewer. Filed `Brown_2022_aerial-animal-detection-spatial-resolution`. Note: the first Anna's Archive fetch attempt was mis-matched to an unrelated 2015 solar-radiation paper and was quarantined.**
...
- Wu, C., Du, B., Cui, X. & Zhang, L. (2017). A post-classification change detection method based on iterative slow feature analysis and Bayesian soft fusion. *RSE*. doi:10.1016/j.rse.2017.07.009 — **ABSTRACT** **Obtained 2026-09-13 (Anna's Archive member route), header-verified, unread by the reviewer. Filed `Wu_2017_iterative-slow-feature-change-detection`.**
...
- Hecht, R., Meinel, G. & Buchroithner, M. (2015). Automatic identification of building types based on topographic databases — a comparison of different data sources. *Int. J. Cartography* 1(1). doi:10.1080/23729333.2015.1055644 — **METADATA ⚠ NUMBERS** **Obtained 2026-09-13 (Anna's Archive member route), header-verified, unread by the reviewer. Filed `Hecht_2015_automatic-identification-building-types`.**
...
- Yang, J. & Huang, X. (2021). The 30 m Annual Land Cover Dataset and Its Dynamics in China from 1990 to 2019 (CLCD). *ESSD* 13(8). doi:10.5194/essd-13-3907-2021 — **METADATA ⚠ NUMBERS** **Obtained 2026-09-13 (open access, Copernicus, curl), header-verified, unread by the reviewer. Filed `Yang_2021_30m-annual-land-cover-china`.**
...
- Bellettini, Caselles & Novaga (2002). The Total Variation Flow in R^N. *J. Differential Equations* 184(2):475–525 — **UNREADABLE** at round 4 (the `.txt` extract was garbled under `pdftotext` and `pypdf`; the PDF itself is byte-identical to the clean copy). Filed `Bellettini_2002_total-variation-flow` (duplicate PDF quarantined, merged 2026-09-13; see line 2690).
...
- Averkov, G. & Bianchi, G. (2009). Confirmation of Matheron's conjecture on the covariogram of a planar convex body. *J. Eur. Math. Soc.* 11:1187–1202. doi:10.4171/jems/179 — filed, searcher-verified, unread. Filed `Averkov_2009_confirmation-matheron-s-conjecture`.
...
- Higham, N.J. & Lin, L. (2011). On pth roots of stochastic matrices. *Linear Algebra Appl.* 435(3):448–463. doi:10.1016/j.laa.2010.04.007 — **PRIMARY**, reviewer-read (§3; MIMS eprint). Filed `Higham_2011_pth-roots-stochastic-matrices`.
...
- **Blakemore (1984)** *Cartographica* doi:10.3138/1005-13mg-2627-2552 and **Hall (1985)** *Stoch. Proc. Appl.* 20 doi:10.1016/0304-4149(85)90212-1 — obtained 2026-09-12 in the acquisition pass (first index; second index by curl), header-verified, unread by the reviewer; filed `Blakemore_1984_generalisation-error-spatial`, `Hall_1985_resampling-coverage-pattern`. **Page (1954)** *Biometrika* 41 doi:10.1093/biomet/41.1-2.100 (JSTOR form doi:10.2307/2333009) **Obtained 2026-09-13 (Anna's Archive member route via DOI 10.2307/2333009), header-verified, unread by the reviewer. Filed `Page_1954_continuous-inspection-schemes`.** **Still not obtained:** Lahiri (2003) *Resampling Methods for Dependent Data* ch. 12 doi:10.1007/978-1-4757-3803-2_12; Matheron (1975) *Random Sets and Integral Geometry* (book) — **METADATA**. **No DOI in any index:** Kreinin & Sidelnikova (2001) *Algo Research Quarterly* 4(1/2); Lewis & Mohler (2011) preprint.
