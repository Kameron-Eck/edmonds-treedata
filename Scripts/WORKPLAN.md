...
| **Harmonization EXP-H1/H2 on resnet18 (2026-09-10 overnight; design `Reports/HARMONIZATION_DESIGN_2026-09-10.md`, pre-registered `experiments/harmonization_h1_h2.yaml`)** — EXP-H1 COMPLETE: five-year base spread of matched_p75 recall 0.140 vs C-CAP 2021 / 0.154 vs C-CAP 2016 (`phase4/qc/harm_spread.csv`); H1-K1 and H1-K2 both NOT fired, so the premise stands and the metric is usable; 2019n is the worst survey on resnet18 (0.603), not 2006s. EXP-H2 (2016 structure channel, `--hs-source chm2`) arms on harmh2: 2019s base + in16 clean, 2016/2011s/2020 in16 pending; then `queue_harm_h2_score.yaml`, K1 interaction / K2 change laundering / K3 same-flight gap / K4 2016 null | H2 verdict this morning; Kam: whether to pursue harmonization at all if H2-K1 fires (the record predicts it does) |
