...
| **Crown state model (method 1) — PRE-REGISTERED 2026-09-10** (`experiments/crown_state_model.yaml`, Kam: "I'm on board for method 1"): two-state hidden model per 2020 crown, per-survey emission rates from delivered-cut citywide scores, two-epoch gain persistence; kills K1 laundering, K2 triples vs the healer's 240/327, K3 shuffled-rate placebo, K4 rate-reference sensitivity incl. 2005/2016 lidar; implementer/referee split. Instrument + 15 tests landed `9673a03`; blocks until heal_2020's delivered-cut rate lands (rescoring after a mirror read fault) | referee run + score this morning |
