...
| **4.2** | training-only HR auxiliary branch | **DROPPED 2026-08-31, premise false.** "The archive supplies paired supervision free (a 5 cm acquisition degraded to 100 cm is an (LR input, HR target) sample)" does not hold: degrading a fine acquisition to make the LR half IS degradation synthesis — the workstream Kam PARKED on 2026-08-27 — so the supervision is neither free nor available. Reopening that workstream is Kam's call, not a side effect of an architecture item. |
