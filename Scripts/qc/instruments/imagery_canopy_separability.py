...
╔══════════════════════════════════════════════════════════════════╗
  ...
  USAGE
    py -3.12 qc/instruments/imagery_canopy_separability.py             # every catalog raster
    py -3.12 qc/instruments/imagery_canopy_separability.py --only 2017 # one year / substring
