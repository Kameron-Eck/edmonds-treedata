...
==================================================================
  ...
  USAGE (local Windows, CPU; no GPU, no Colab)
    PYTHONUTF8=1 py -3.12 qc/instruments/nir_change_probe.py
    PYTHONUTF8=1 py -3.12 qc/instruments/nir_change_probe.py --skip-degradation
==================================================================
"""
...
SCRIPTS_DIR = Path(__file__).resolve().parents[2]  # code plane (instruments/ -> qc/ -> Scripts/)
...
def ndvi_from_bands(arr):
    ...
    NDVI = (nir - r) / (nir + r + 1e-6)  -- qc/instruments/phase4_qc_ndvi.py and
