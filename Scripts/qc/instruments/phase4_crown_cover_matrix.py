...
qc/instruments/phase4_sector_series.py -> mean cover fraction per crown per year. The rasterize+bincount
...
def main():
    ...
    if not covers:
        sys.exit("no cover sidecars — run qc/instruments/phase4_sector_series.py first")
