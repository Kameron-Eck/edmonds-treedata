...
╔══════════════════════════════════════════════════════════════════╗
  ...
  THE ESCAPE HATCH THIS SCRIPT POLICES
    ...
    crown_id intact (qc/instruments/mine_stable_crowns.py::CROWNS, written by its main()). Those crowns were
  ...
  ONE READ, EVERY THRESHOLD
    ...
    extra pass. Same trick, same reason, as qc/instruments/phase4_arm_pr_curves.py, whose
  ...
  USAGE
    py -3.12 qc/instruments/phase4_crown_touch.py --year 2009 \
...
# — the same resolution order qc/instruments/mine_stable_crowns.py::CROWNS uses.
...
def main():
    ...
    A("---\n")
    A(f"Generated by `qc/instruments/phase4_crown_touch.py`. Crown layer: `{cpath}`. "
