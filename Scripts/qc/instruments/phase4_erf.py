...
Run:
  py -3.12 qc/instruments/phase4_erf.py --ckpt "G:/My Drive/treedata/phase3/sem_best_2020.pt"
  py -3.12 qc/instruments/phase4_erf.py --ckpt <path> --tiles <tile_dir> --n 32
"""
import argparse
import sys
