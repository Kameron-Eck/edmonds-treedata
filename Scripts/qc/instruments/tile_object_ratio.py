...
20 cm and resolves at 80.7.
  ...
  py -3.12 qc/instruments/tile_object_ratio.py
  py -3.12 qc/instruments/tile_object_ratio.py --crown-m 10.33     # p90 crowns instead of the median
"""
import argparse
import csv
import sys
...
CROWN_MEDIAN_M = 6.46
ERF_PX = 106                               # qc/instruments/phase4_erf.py, RepLKNet method, 16 real tiles
