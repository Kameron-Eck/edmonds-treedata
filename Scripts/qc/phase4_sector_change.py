...
WHAT. Pure post-processing of `qc/phase4_sector_series.py`'s output
...
USAGE
  PYTHONUTF8=1 py -3.12 qc/phase4_sector_change.py
  PYTHONUTF8=1 py -3.12 qc/phase4_sector_change.py --arm xsensor_rgb --weights geometry
"""
import argparse
import csv
import json
