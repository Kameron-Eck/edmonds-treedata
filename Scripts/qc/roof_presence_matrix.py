...
WHAT THIS IS
    The production run of `qc/roof_presence_probe.py`. The probe was a sizing
...
USAGE
    ...
    py -3.12 qc/roof_presence_matrix.py --scope sectors

    # citywide — hours; resumable, safe to kill
    py -3.12 qc/roof_presence_matrix.py --scope city

    # timing pilot
    py -3.12 qc/roof_presence_matrix.py --scope sectors --years 2013 2023n --limit 200
...
def run(args):
    ...
    resume_cmd = (f"py -3.12 qc/roof_presence_matrix.py --scope {args.scope}"
