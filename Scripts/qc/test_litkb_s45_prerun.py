...
def test_constructed_pages_only_the_illegal_character_class_is_repaired(tmp_path):
    ...
    character beside a malformed tag (the repair is counted, the page is still refused)."""
    ...
    for name, desc in (("latin1", b"caf\xe9 \x01 not UTF-8"),
                       ("charref", b"basin&#xFFFE;margin"),
                       ("malformed", b"basin\x01margin <unclosed>")):
