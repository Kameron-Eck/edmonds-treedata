...
DATE_EVIDENCE = {
    ...
    "S18": {"date_shot": "2018-08-07 (WA consortium 6-in flight area over Edmonds)", "date_precision": "single day", "evidence_grade": "PUBLISHED",
            "source_url": "https://services.arcgis.com/jsIt88o09Q0r1j8h/arcgis/rest/services/2018_Statewide_imagery_consortium_6_inch_flight_areas/FeatureServer/0/query",
            "verbatim_quote": "\"IDATE\":\"2018-08-07\" (city-centroid and city-bbox queries agree; raw responses qc/imagery_date_evidence/raw_records/wa_2018_6in_city*.json)",
            "single_or_multi_date": "single flight area", "note": "the ONLY citywide 2018 imagery held; same Aug-07 day-of-month as the 2015 flight by coincidence"},
    "S90": {"date_shot": "NOT FOUND (year from the county service name Aerial_1990 only)", "date_precision": "-", "evidence_grade": "NOT FOUND",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_1990/ImageServer",
            "verbatim_quote": "-", "single_or_multi_date": "unknown", "note": "10-ft b/w; SCOPI's per-year list starts at 2017; no flight-date record found for any pan year"},
    "S98": {"date_shot": "NOT FOUND (year only; the service's keyProperties name the SOURCE, not the date)", "date_precision": "-", "evidence_grade": "NOT FOUND",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_1998/ImageServer/keyProperties?f=json",
            "verbatim_quote": r"U:\\1998\\b-w\\3ft_res\\dnr\\t26nr04e.tif (keyProperties IMAGE__INPUT_NAME, JSON escaping verbatim - a WA DNR 3-ft b/w product; raw response qc/imagery_date_evidence/raw_records/snoco_1998_keyProperties.json)",
            "single_or_multi_date": "unknown", "note": "source = WA DNR 1998 orthophoto scan; pairs with the held 1998_king_pan (different product)"},
    "S01": {"date_shot": "NOT FOUND (year from the county service name Aerial_2001 only)", "date_precision": "-", "evidence_grade": "NOT FOUND",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2001/ImageServer",
            "verbatim_quote": "-", "single_or_multi_date": "unknown", "note": "1-ft scanned film (effective 105 cm); no flight-date record found"},
    "N19f": {"date_shot": "2019-10-11", "date_precision": "single day", "evidence_grade": "PUBLISHED",
            "source_url": "https://naipeuwest.blob.core.windows.net/naip?restype=container&comp=list&prefix=v002/wa/2019/wa_60cm_2019/47122/m_47122&maxresults=200",
            "verbatim_quote": "m_4712213_ne_10_060_20191011.tif ... m_4712214_sw_10_060_20191011.tif (all 8 Edmonds quads carry 20191011; listing saved qc/imagery_date_evidence/raw_records/azure_naip_2019_47122_listing.xml)",
            "single_or_multi_date": "single (all 8 quads 2019-10-11)",
            "note": "= the S19/HXIP flight date (same Hexagon acquisition); replaces the smoothed 69% clip; reg-loss waived as a blur artifact of the metric (registration_blur_test.json)"},
    "N23f": {"date_shot": "2023-10-07", "date_precision": "single day", "evidence_grade": "PUBLISHED",
            "source_url": "https://naipeuwest.blob.core.windows.net/naip?restype=container&comp=list&prefix=v002/wa/2023/wa_060cm_2023/47122/m_47122&maxresults=200",
            "verbatim_quote": "m_4712213_ne_10_060_20231007_20240209.tif ... m_4712214_sw_10_060_20231007_20240209.tif (all 8 Edmonds quads carry capture 20231007 + version 20240209; listing saved qc/imagery_date_evidence/raw_records/azure_naip_2023_47122_listing.xml)",
            "single_or_multi_date": "single (all 8 quads 2023-10-07)", "note": "confirms the held 2023n date independently; October leaf-state caveat as 2019n/2019s"},
    "S02": {"date_shot": "NOT FOUND (year from the county service name Aerial_2002 only)", "date_precision": "-", "evidence_grade": "NOT FOUND",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2002/ImageServer",
            "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "note": "NOT the USGS HRO flight: dup test vs 2002_usgs_30cm_rgb r median 0.847 at the 5 sites (same-flight pairs run 0.98-0.997; SnoCo/_acq/S02/dup_test_vs_U02.json) - a second, distinct 2002 acquisition with its own unknown date"},
    "S03": {"date_shot": "NOT FOUND (year from the county service name Aerial_2003 only)", "date_precision": "-", "evidence_grade": "NOT FOUND",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2003/ImageServer",
            "verbatim_quote": "-", "single_or_multi_date": "unknown", "note": "2003 = a calendar year the project previously had NO imagery for"},
    "S07": {"date_shot": "NOT FOUND (year from the county service name Aerial_2007 only)", "date_precision": "-", "evidence_grade": "NOT FOUND",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2007/ImageServer",
            "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "note": "flip test vs 2007_king FAILED (eff 38.5 vs required < 22.95) - complement, King keeps the 2007 key"},
    "S09": {"date_shot": "NOT FOUND (year from the county service name Aerial_2009 only)", "date_precision": "-", "evidence_grade": "NOT FOUND", "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2009/ImageServer",
            "note": "Aerials Express product per the service; possibly the same flight as 2009_king - identity untested"},
    "S11": {"date_shot": "NOT FOUND (year from the county service name Aerial_2011 only)", "date_precision": "-", "evidence_grade": "NOT FOUND", "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2011/ImageServer",
            "note": "2011 = a calendar year the project previously had NO imagery for"},
    "S12": {"date_shot": "NOT FOUND (year from the county service name Aerial_2012 only)", "date_precision": "-", "evidence_grade": "NOT FOUND", "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2012/ImageServer",
            "note": "the year the county sells on media; free from the public service; sharper than 2012_king on a common grid but 82.3% coverage"},
    "S96": {"date_shot": "NOT FOUND (year from the county service name Aerial_1996 only)", "date_precision": "-", "evidence_grade": "NOT FOUND", "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_1996/ImageServer",
            "note": "earliest COLOR imagery of Edmonds held; outside the 2000-2024 span, no year key"},
    "S06": {"date_shot": "NOT FOUND (year from the county service name Aerial_2006 only)", "date_precision": "-", "evidence_grade": "NOT FOUND", "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2006/ImageServer",
            "note": "2006 = a new project year; likely the NAIP 2006 republished (untested)"},
    "S13": {"date_shot": "NOT FOUND (year from the county service name Aerial_2013 only)", "date_precision": "-", "evidence_grade": "NOT FOUND", "verbatim_quote": "-", "single_or_multi_date": "unknown",
            "source_url": "https://gis.snoco.org/img/rest/services/Imagery/Aerial_2013/ImageServer",
            "note": "1-m complement to 2013_king"},
    "S20": {"inherit": "2020_coe_rgb.tif", "note": "same county EagleView 2020 programme the anchor was cut from; ANCHOR NEVER FLIPPED; no JPEG signature (held CoE copy has one)"},
    "S22": {"inherit": "2022_coe_rgb.tif", "note": "same county EagleView 2022 programme; no JPEG signature (held CoE copy has one)"},
    "S24": {"inherit": "2024_coe_rgb.tif", "note": "same county EagleView 2024 programme; no JPEG signature (held CoE copy has one)"},
    ...
    for tid, t in targets.items():
        ...
        rows.append({
            ...
            "native_flight_cm": {"S16": "30.48 (county 1-ft delivery)", "S17": "30.48", "S19": "30.48", "S15": "30.48", "S21": "15.24 (0.5 ft)",
                                 ...
                                 "S18": "15.24 (0.5 ft HXIP 6-in delivery)", "S90": "304.8 (10 ft)",
                                 "S98": "91.44 (3 ft DNR scan)", "S01": "30.48 (1 ft scanned film)",
                                 "N23f": "60 (delivered DOQQ)", "N19f": "60 (delivered DOQQ)",
                                 "S02": "30.48 (1 ft)", "S03": "30.48 (1 ft)", "S07": "30.48 (1 ft)",
                                 "S09": "30.48 (1 ft)", "S11": "30.48 (1 ft)", "S12": "22.86 (0.75 ft)",
                                 "S96": "100 (1 m)", "S06": "100 (1 m)", "S13": "100 (1 m)",
                                 "S20": "7.62 (0.25 ft)", "S22": "7.62 (0.25 ft)", "S24": "7.62 (0.25 ft)",
