# Height rasters as STANDALONE canopy classifiers — `mechanism`
...
| `smooth1(max1(chm2))` | derived: `max1(chm2)` under a 3x3 px (3 m) box MEAN — the second half of the old product's dilate-and-blur mechanism | — | — | — |
...
| `smooth1(max1(chm2))` | 60.82% | 42,103,555 | 0.30% dropped by the intersection | 9.64% |
...
| `smooth1(max1(chm2))` | 0.8964 | [0.8898, 0.9039] | 0.8675 | 7.8 m | 0.7780 | 7.8 m | 0.6314 |
| `smooth2(max2(chm2))` | 0.9073 | [0.9012, 0.9141] | 0.8754 | 9.4 m | 0.7941 | 9.4 m | 0.6570 |

## Performance by height threshold — where does each raster discriminate?

Recall / precision / F1 of the rule *canopy iff height >= h*.

| h (m) | `chm` R/P/F1 | `chm2` R/P/F1 | `max1(chm2)` R/P/F1 | `max2(chm2)` R/P/F1 | `smooth1(max1(chm2))` R/P/F1 | `smooth2(max2(chm2))` R/P/F1 |
|---|---|---|---|---|---|---|
| 0.0 | 1.000/0.400/0.571 | 1.000/0.400/0.571 | 1.000/0.400/0.571 | 1.000/0.400/0.571 | 1.000/0.400/0.571 | 1.000/0.400/0.571 |
| 1.0 | 0.999/0.456/0.626 | 0.850/0.592/0.698 | 0.968/0.521/0.677 | 0.994/0.474/0.642 | 0.988/0.500/0.664 | 0.999/0.449/0.619 |
| 2.0 | 0.995/0.486/0.653 | 0.812/0.617/0.701 | 0.945/0.554/0.699 | 0.987/0.505/0.668 | 0.967/0.542/0.695 | 0.996/0.481/0.649 |
| 3.0 | 0.985/0.512/0.674 | 0.770/0.642/0.700 | 0.913/0.581/0.710 | 0.969/0.529/0.685 | 0.934/0.578/0.714 | 0.985/0.514/0.676 |
| 4.0 | 0.964/0.552/0.702 | 0.725/0.693/0.709 | 0.872/0.625/0.728 | 0.941/0.566/0.707 | 0.892/0.627/0.737 | 0.963/0.558/0.706 |
| 5.0 | 0.936/0.598/0.729 | 0.689/0.737/0.712 | 0.835/0.668/0.742 | 0.910/0.607/0.728 | 0.850/0.678/0.754 | 0.931/0.608/0.736 |
| 6.0 | 0.905/0.644/0.753 | 0.654/0.787/0.714 | 0.798/0.716/0.755 | 0.877/0.652/0.748 | 0.811/0.727/0.767 | 0.897/0.659/0.760 |
| 8.0 | 0.843/0.738/0.787 | 0.596/0.866/0.706 | 0.735/0.801/0.767 | 0.815/0.741/0.776 | 0.742/0.817/0.778 | 0.830/0.754/0.790 |
| 10.0 | 0.788/0.796/0.792 | 0.548/0.907/0.683 | 0.682/0.850/0.757 | 0.763/0.795/0.779 | 0.683/0.868/0.765 | 0.770/0.818/0.793 |
| 12.0 | 0.734/0.851/0.788 | 0.503/0.932/0.654 | 0.632/0.892/0.740 | 0.713/0.849/0.775 | 0.631/0.902/0.743 | 0.714/0.862/0.781 |
| 15.0 | 0.661/0.886/0.757 | 0.438/0.947/0.599 | 0.563/0.916/0.697 | 0.643/0.881/0.743 | 0.558/0.925/0.696 | 0.638/0.896/0.745 |
| 20.0 | 0.533/0.920/0.675 | 0.328/0.961/0.489 | 0.441/0.939/0.600 | 0.518/0.914/0.661 | 0.434/0.948/0.595 | 0.508/0.929/0.657 |
...
| `chm` vs `smooth1(max1(chm2))` | +0.0095 | 0.0013 | yes |
| `chm` vs `smooth2(max2(chm2))` | -0.0014 | 0.0006 | yes |
| `chm2` vs `max1(chm2)` | -0.0414 | 0.0019 | yes |
| `chm2` vs `max2(chm2)` | -0.0520 | 0.0026 | yes |
| `chm2` vs `smooth1(max1(chm2))` | -0.0535 | 0.0022 | yes |
| `chm2` vs `smooth2(max2(chm2))` | -0.0644 | 0.0030 | yes |
| `max1(chm2)` vs `max2(chm2)` | -0.0106 | 0.0009 | yes |
| `max1(chm2)` vs `smooth1(max1(chm2))` | -0.0122 | 0.0005 | yes |
| `max1(chm2)` vs `smooth2(max2(chm2))` | -0.0231 | 0.0014 | yes |
| `max2(chm2)` vs `smooth1(max1(chm2))` | -0.0015 | 0.0007 | yes |
| `max2(chm2)` vs `smooth2(max2(chm2))` | -0.0124 | 0.0006 | yes |
| `smooth1(max1(chm2))` vs `smooth2(max2(chm2))` | -0.0109 | 0.0010 | yes |
...
| `chm` vs `smooth1(max1(chm2))` | +0.0095 | [+0.0082, +0.0108] | 100.0% | +0.0046 | [+0.0030, +0.0065] | `chm` **BETTER** than `smooth1(max1(chm2))` |
| `chm` vs `smooth2(max2(chm2))` | -0.0014 | [-0.0020, -0.0007] | 100.0% | -0.0033 | [-0.0043, -0.0022] | `chm` **WORSE** than `smooth2(max2(chm2))` |
...
| `chm2` vs `smooth1(max1(chm2))` | -0.0535 | [-0.0559, -0.0514] | 100.0% | -0.0481 | [-0.0519, -0.0448] | `chm2` **WORSE** than `smooth1(max1(chm2))` |
| `chm2` vs `smooth2(max2(chm2))` | -0.0644 | [-0.0676, -0.0615] | 100.0% | -0.0560 | [-0.0609, -0.0518] | `chm2` **WORSE** than `smooth2(max2(chm2))` |
| `max1(chm2)` vs `max2(chm2)` | -0.0106 | [-0.0115, -0.0097] | 100.0% | -0.0053 | [-0.0063, -0.0042] | `max1(chm2)` **WORSE** than `max2(chm2)` |
| `max1(chm2)` vs `smooth1(max1(chm2))` | -0.0122 | [-0.0127, -0.0117] | 100.0% | -0.0120 | [-0.0130, -0.0110] | `max1(chm2)` **WORSE** than `smooth1(max1(chm2))` |
| `max1(chm2)` vs `smooth2(max2(chm2))` | -0.0231 | [-0.0244, -0.0216] | 100.0% | -0.0198 | [-0.0219, -0.0181] | `max1(chm2)` **WORSE** than `smooth2(max2(chm2))` |
| `max2(chm2)` vs `smooth1(max1(chm2))` | -0.0015 | [-0.0023, -0.0009] | 100.0% | -0.0067 | [-0.0082, -0.0055] | `max2(chm2)` **WORSE** than `smooth1(max1(chm2))` |
| `max2(chm2)` vs `smooth2(max2(chm2))` | -0.0124 | [-0.0130, -0.0118] | 100.0% | -0.0146 | [-0.0160, -0.0133] | `max2(chm2)` **WORSE** than `smooth2(max2(chm2))` |
| `smooth1(max1(chm2))` vs `smooth2(max2(chm2))` | -0.0109 | [-0.0119, -0.0098] | 100.0% | -0.0079 | [-0.0092, -0.0067] | `smooth1(max1(chm2))` **WORSE** than `smooth2(max2(chm2))` |
