...
Resampling unit: 2048x512 px blocks · **342 non-empty blocks** · 60 replicates · paired (same blocks per replicate)
...
Split mask: `add_nodecW_2009.tif`, buffer 512 px. **inside** = where labels were added (plus buffer); **outside** = the rest.
...
|---|---|---|---|---|---|---|
| `nodec_v1` | +0.0116 | [+0.0100, +0.0140] | 100.0% | +0.0223 | [+0.0182, +0.0266] | 100.0% |

## Region: inside

| arm | AUROC | PR-AUC |
|---|---|---|
| `rgb3_nodeb` | 0.8995 | 0.8427 |
| `nodec_v1` | 0.9081 | 0.8609 |

Gaps vs `rgb3_nodeb` (95% percentile CI of the paired difference)

| arm | dAUROC | 95% CI | sign stable | dPR-AUC | 95% CI | sign stable |
|---|---|---|---|---|---|---|
| `nodec_v1` | +0.0086 | [+0.0062, +0.0112] | 100.0% | +0.0183 | [+0.0137, +0.0239] | 100.0% |

## Region: outside

| arm | AUROC | PR-AUC |
|---|---|---|
| `rgb3_nodeb` | 0.9126 | 0.8282 |
| `nodec_v1` | 0.9285 | 0.8563 |

Gaps vs `rgb3_nodeb` (95% percentile CI of the paired difference)

| arm | dAUROC | 95% CI | sign stable | dPR-AUC | 95% CI | sign stable |
|---|---|---|---|---|---|---|
| `nodec_v1` | +0.0159 | [+0.0135, +0.0197] | 100.0% | +0.0281 | [+0.0227, +0.0357] | 100.0% |
